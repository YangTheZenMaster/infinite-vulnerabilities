<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"D:\phpstudy\PHPTutorial\WWW\cumtdininghall\public/../application/admin\view\comment\commentlist.html";i:1557966606;s:77:"D:\phpstudy\PHPTutorial\WWW\cumtdininghall\application\admin\view\layout.html";i:1558101342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td><a href="<?php echo url('admin/Comment/delete'); ?>?id=<?php echo $value['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>删除</a></td>
    </tr>
    <?php endforeach; ?>
</table>
