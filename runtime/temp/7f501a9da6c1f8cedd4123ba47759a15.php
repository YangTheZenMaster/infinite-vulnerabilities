<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"D:\phpstudy\PHPTutorial\WWW\cumtdininghall\public/../application/admin\view\user\edit.html";i:1558099827;s:77:"D:\phpstudy\PHPTutorial\WWW\cumtdininghall\application\admin\view\layout.html";i:1558101342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="form-horizontal" action="update" method="post">
    ...
    <!-- xss injection point here -->
    <?php echo '<input name="id" value="'.$id.'" type="hidden">'; ?>
    <!-- xss injection point here -->

    <?php
        echo"您的ip为".$local_ip.",请注意行为规范!".'<br>';
        $cmd=shell_exec('ping '.$ip);//命令执行注入点
        echo $cmd;
    ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="username" placeholder="用户名" name="name" value="<?php echo $data['name']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="password" class="col-sm-2 control-label">密码</label>
        <div class="col-sm-3">
            <input type="password" class="form-control" id="password" placeholder="密码" name="password" value="<?php echo $data['password']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="repassword" class="col-sm-2 control-label">确认密码</label>
        <div class="col-sm-3">
            <input type="password" class="form-control" id="repassword" placeholder="确认密码" name="repassword" value="<?php echo $data['repassword']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="email" class="col-sm-2 control-label">邮箱</label>
        <div class="col-sm-3">
            <input type="email" class="form-control" id="email" placeholder="邮箱" name="email" value="<?php echo $data['email']; ?>">
        </div>
    </div>
    <div class="form-group">
